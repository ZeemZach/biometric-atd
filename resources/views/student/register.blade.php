    ...
    <article class="card-body mx-auto" style="max-width: 400px;">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group input-group">
                ...
                <input id="Text2" type="text" name="roll_no" class="form-control" placeholder="Roll number" maxlength="4" required>
            </div>
            <div class="form-group input-group">
                <div class="input-group-prepend">
            ...
            <div class="form-group input-group">
                ...
                <input id="Text3" type="text" name="finger_id" class="form-control" placeholder="Fingure ID"
            ...
            <div class="form-group input-group">
                ...
                <input id="Text4" type="text" name="phone" class="form-control" placeholder="Phone number" maxlength="10" required>
            </div> <!-- form-group// -->
            <div class="form-group input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
                </div>
                <input d="Text5" type="email" name="email" class="form-control" placeholder="Email address"
                maxlength="30" required>
            </div> <!-- form-group// -->
            <div class="form-group input-group">
                <div class="input-group-prepend">
